...
function loadStatsPage(){
	...
	document.getElementById("losses").innerHTML+=BuffLoss;
}
...
function loadPlayersPage(){
	var playaMenu=document.getElementById("player_selector");
	var insert="";
	for(var i=0; i<players.length;i++){
		var playa=players[i].name;
		insert= insert+"<a class= 'dropdown-item' href='#' onclick='switchPlayers("+ i +")'>"+playa+"</a>"
	}
	playaMenu.innerHTML=insert;
}			
